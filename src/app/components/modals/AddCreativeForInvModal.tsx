...
const AddCreativeForInvModal: React.FC<AddCreativeForInvModalProps> = ({ onClose, inventoryId }) => {
  ...
  const bookingIds = bookingSets.map(set => set.bookingId);
          ...
          <form onSubmit={handleSubmit} id="bookingForm">
            <div className="mb-4">
              <h1 className="w-full text-2xl font-bold text-center">
                {inventoryOptions.find(creative => creative.value === inventoryId)?.label || "Inventory not valid"}
              </h1>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-1 px-4 py-2">
                ...
                <span className="text-blue-500 font-medium">Add Next Creative</span>
              </div>
            </div>
          </form>
        </div>
